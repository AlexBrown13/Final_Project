    ...
    <main className="page-shell">
      ...
      <section className="card spacious">
        ...
        <div className="chat-box">
          ...
          {messages.length === 0 && (
            <div className="bubble assistant">{t.noResultYet}</div>
          )}
        </div>
...
function PlaceholderGraph({ title, description, height = "220px" }) {
  return (
    <article
      className="placeholder-box graph-box"
  ...
  if (score === 1) {
    return (
      <div className="results-content score1">
        ...
        <section className="card">
          <h3>
            {lang === HE_HEBREW ? "סיפור אישי קצר" : "A short personal story"}
          </h3>
          <p>
            {lang === HE_HEBREW
        ...
        <section className="card">
          <h3>
            {lang === HE_HEBREW
              ? "הסבר פשוט על תגובת הגוף"
              : "Simple body response explanation"}
          </h3>
          <p>
            {lang === HE_HEBREW
    ...
    return (
      <div className="results-content score2">
        ...
        <section className="card-grid">
          ...
          <article className="card">
            <h3>
              {lang === HE_HEBREW ? "השפעה תפקודית" : "Functional impact"}
            </h3>
            <p>
              {lang === HE_HEBREW
    ...
    <div className="results-content score3">
      <section className="card compact">
        ...
        <ul>
          <li>
            {lang === HE_HEBREW
              ? "מדדי תחלואה: PTSD, דיכאון, חרדה נלווית"
              : "Morbidity indicators: PTSD, depression, comorbid anxiety"}
          </li>
          <li>
            {lang === HE_HEBREW
              ? "מודל רב-שכבתי: פרט, משפחה, קהילה, מערכת"
              : "Multi-layer model: individual, family, community, system"}
          </li>
          <li>
            {lang === HE_HEBREW
              ? "השלכות שירות: עומס על קווי סיוע ומרפאות"
              : "Service implications: load on helplines and clinics"}
          </li>
        </ul>
      </section>
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td>2022</td>
                <td>
                  {lang === HE_HEBREW ? "מבוגרים - דרום" : "Adults - South"}
                </td>
                <td>24.6</td>
              ...
              <tr>
                <td>2024</td>
                <td>
                  {lang === HE_HEBREW ? "צוותי חירום" : "Emergency teams"}
                </td>
                <td>31.1</td>
