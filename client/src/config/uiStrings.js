...
const STRINGS = {
  he: {
    ...
    quizSubtitle: "ענו בשקט ובקצב שנוח לכם — אין תשובה נכונה או לא נכונה. כתבו \"סיימתי\" בכל שלב כדי לסיים.",
    ...
    articlesTitle: "מאמרים אקדמיים",
    articlesRefresh: "רענון",
    articlesLoading: "טוען…",
    articlesAuthors: "מחברים",
    articlesJournal: "כתב עת",
    articlesUrl: "קישור",
    articlesDownloadPdf: "הורדת PDF",
    articlesPdfUnavailable: "אין קובץ PDF זמין",
    articlesAbstract: "תקציר",
    articlesEmpty: "לא נמצאו מאמרים עבור משתמש זה.",
    articlesNoAbstract: "אין תקציר זמין",
    articlesUnknownAuthor: "לא ידוע",
    articlesYearNa: "שנה לא זמינה",
    articlesNoTitle: "ללא כותרת",
    articlesErrorAuth: "חסרים אסימון התחברות או מזהה משתמש. התחברו מחדש.",
    ...
    tabArticles: "מאמרים",
    tabProfile: "פרופיל",
    profilePersonaLabel: "פרסונה",
    profileTagsLabel: "תחומי עניין",
    profilePreferredLabel: "העדפת תוכן",
    profileQueryLabel: "נושאי עניין",
    profileQueryHint: "הקלד נושא ולחץ Enter להוספה. המאמרים יעודכנו בהתאם לנושאים שבחרת.",
    profileTagsPlaceholder: "הוסף נושא…",
    profileTagsMax: "הגעת למקסימום 5 נושאים",
    ...
    crisisDismiss: "סגור",
    // Results-page shared chrome (BeginnerResults / InformedResults / ResearcherResults)
    resultsBrand: "חינוך בנושא טראומה",
    resultsBrandResearcher: "חינוך_טראומה",
    resultsNavResults: "תוצאות",
    resultsResearcherMode: "מצב חוקר",
    resultsBadgeInformed: "לומד מתעניין",
    resultsBadgeResearcher: "חוקר",
    resultsPrimaryTopic: "נושא מרכזי",
    resultsTopicsPanelTitle: "הנושאים שלך",
    resultsEditTags: "עריכת תגיות עניין",
    resultsEditTagsShort: "עריכת תגיות",
    resultsAddTopic: "הוספת נושא…",
    resultsAddBtn: "הוספה",
    resultsMaxTopics: "אפשר לעקוב אחרי עד חמישה נושאים.",
    resultsMaxTopicsShort: "מקסימום 5 תגיות",
    resultsCloseEdit: "סגירה",
    resultsCtaHead: "רשימת הקריאה המלאה והמותאמת שלך",
    resultsCtaSub: "סיפורים ומחקר, מאורגנים סביב התגיות שאתם עוקבים אחריהן.",
    resultsCtaBtn: "לרשימת המאמרים המלאה ←",
    resultsExploreHead: "אפשר גם לחקור",
    resultsExploreMap: "מפה אינטראקטיבית",
    resultsExploreMapDesc: "רשומות פניות לקווי החירום בערי ישראל, לאורך זמן.",
    resultsExploreTrends: "מגמות",
    resultsExploreTrendsDesc: "התעניינות בחיפוש אחר מונחי טראומה ברחבי ישראל.",
    resultsExploreGraphs: "גרפים",
    resultsExploreGraphsDesc: "התמכרויות, שינה, אלימות במשפחה, עומס מערכתי.",
  },
  en: {
    ...
    quizSubtitle:
      "Answer gently and at your own pace — there are no wrong answers. Type \"done\" at any point to finish early.",
    ...
    articlesTitle: "Academic articles",
    articlesRefresh: "Refresh",
    articlesLoading: "Loading…",
    articlesAuthors: "Authors",
    articlesJournal: "Journal",
    articlesUrl: "URL",
    articlesDownloadPdf: "Download PDF",
    articlesPdfUnavailable: "PDF unavailable",
    articlesAbstract: "Abstract",
    articlesEmpty: "No articles found for this user.",
    articlesNoAbstract: "No abstract available",
    articlesUnknownAuthor: "Unknown",
    articlesYearNa: "Year N/A",
    articlesNoTitle: "No title",
    articlesErrorAuth: "Missing login token or user id. Please sign in again.",
    articlesErrorFetchPrefix: "Failed to fetch articles",
    articlesErrorFetch: "Could not load articles.",
    tabArticles: "Articles",
    tabProfile: "Profile",
    profilePersonaLabel: "Persona",
    profileTagsLabel: "Interests",
    profilePreferredLabel: "Preferred content",
    profileQueryLabel: "Topics",
    profileQueryHint: "Type a topic and press Enter to add it. Articles will update based on your selected topics.",
    profileTagsPlaceholder: "Add a topic…",
    profileTagsMax: "Maximum 5 topics reached",
    ...
    crisisDismiss: "Close",
    // Results-page shared chrome (BeginnerResults / InformedResults / ResearcherResults)
    resultsBrand: "trauma education",
    resultsBrandResearcher: "trauma_education",
    resultsNavResults: "Results",
    resultsResearcherMode: "researcher mode",
    resultsBadgeInformed: "Informed Learner",
    resultsBadgeResearcher: "Researcher",
    resultsPrimaryTopic: "Primary topic",
    resultsTopicsPanelTitle: "Your topics",
    resultsEditTags: "Edit interest tags",
    resultsEditTagsShort: "Edit tags",
    resultsAddTopic: "Add a topic…",
    resultsAddBtn: "Add",
    resultsMaxTopics: "You can follow up to five topics.",
    resultsMaxTopicsShort: "Max 5 tags",
    resultsCloseEdit: "Close",
    resultsCtaHead: "Your complete personalized reading list",
    resultsCtaSub: "Stories and research, organized around the tags you follow.",
    resultsCtaBtn: "See your curated article set →",
    resultsExploreHead: "Also explore",
    resultsExploreMap: "Interactive Map",
    resultsExploreMapDesc: "Crisis-line call records across Israeli cities, over time.",
    resultsExploreTrends: "Trends",
    resultsExploreTrendsDesc: "Search interest in trauma terms across Israel.",
    resultsExploreGraphs: "Data Graphs",
    resultsExploreGraphsDesc: "Addictions, sleep, domestic violence, system load.",
  },
};
